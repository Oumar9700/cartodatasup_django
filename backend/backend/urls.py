...
from admissions.views import RegisterView, LoginView, LogoutView, FormationParStatutView, FormationsStatsView
...
urlpatterns = [
    ...
    path('api/formations/stats/', FormationsStatsView.as_view(), name='ratio-capacity-candidates'),
